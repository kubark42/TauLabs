...
/**
 * Input objects: Accels, VibrationAnalysisSettings
 * Output object: VibrationAnalysisOutput
 *
 ...
 */
	...
	while(1)
	{
		...
		vtd->accel_buffer_complex_x_q15[sample_count*2] = roundf((accels_avg_x - vtd->accels_static_bias_x)*FLOAT_TO_Q15);
		vtd->accel_buffer_complex_y_q15[sample_count*2] = roundf((accels_avg_y - vtd->accels_static_bias_y)*FLOAT_TO_Q15);
		vtd->accel_buffer_complex_z_q15[sample_count*2] = roundf((accels_avg_z - vtd->accels_static_bias_z)*FLOAT_TO_Q15);
