...
class GeofenceModelMapProxy : public QObject
{
    ...
    Q_OBJECT
public:
    explicit GeofenceModelMapProxy(QObject *parent, OPMapWidget *map, GeoFenceVerticesDataModel *verticesModel, QItemSelectionModel *selectionModel, GeoFenceFacesDataModel *fencesModel, QItemSelectionModel *facesSelectionModel);
